package com.deeplake.henryhelper;

import com.deeplake.henryhelper.meta.MetaUtil;
import com.deeplake.henryhelper.proxy.ProxyBase;
import com.deeplake.henryhelper.util.CommonDef;
import com.deeplake.henryhelper.util.Reference;
...
public class IdlFramework {
    public static final String MODID = "henryhelper";
    public static final String NAME = "Henry's TFC Helper";
