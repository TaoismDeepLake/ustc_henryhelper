package com.deeplake.henryhelper.util.NBTStrDef;

import com.deeplake.henryhelper.IdlFramework;
...
public class IDLNBTDef {
	...
	public static final String NAME_OFF= "henryhelper.shared.off";
	public static final String NAME_ON= "henryhelper.shared.on";
	...
	//gua socket
	public static final String GUA_NO_FREE_SOCKET_DESC = "henryhelper.gua_enhance_no_free.desc";
	public static final String GUA_FREE_SOCKET_DESC = "henryhelper.gua_enhance_free.desc";
	public static final String GUA_TOTAL_SOCKET_DESC = "henryhelper.gua_enhance_total.desc";
	public static final String GUA_N_A_DESC = "henryhelper.gua_not_applicable.desc";
	...
	public static final String KILL_COUNT_DESC = "henryhelper.kill_count.desc";
